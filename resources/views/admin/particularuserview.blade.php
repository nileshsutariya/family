...
<a href="{{route('family.village')}}" class="btn btn-sm btn-primary ml-4 mt-2"> 
    <i class="bi bi-arrow-left me-1"></i> Back
</a>
<a href="{{route('edit.members', $users->id)}}" class="btn btn-sm mt-2 btn-primary float-right mr-4">
